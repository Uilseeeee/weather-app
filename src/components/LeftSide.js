...
const LeftSide = (props) => {
  const { weather } = props;
  return (
    <div className='h-[77%] w-[44%] bg-white rounded-[48px] justify-self-center self-center justify-around z-50 my-[16%]'>
      <div className='text-black'>
        ...
        <img className='h-2/3 w-2/3 justify-self-center my-[19%]' 
          ...
          alt=''
        />
        <div className='text-5xl text-[99px] font-extrabold bg-gradient-to-b from-[#111827] to=[#6B7280] bg-clip-text text-transparent mx-[2%]'>{weather.max_c}°</div>
